...
public class Main 
{
    ...
    {
        Worker worker1 = new Worker("Maciek", 3500, 1);
        Worker worker2 = new Worker("Jasiek", 3600, 2);
        Worker worker3 = new Worker("Tadek", 4500, 3);
        Worker worker4 = new Worker("Kamil", 6000, 4);
